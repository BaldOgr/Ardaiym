...
public class ButtonDao extends AbstractDao {
    ...
    public void updateButtonText(int buttonId, String newText, String url) throws SQLException {
        PreparedStatement ps = connection.prepareStatement("update button set text=?, url = ? where id=?");
        ps.setString(1, newText);
        ps.setString(2, url);
        ps.setInt(3, buttonId);
